...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        // ✅ Validation
        if (empty($full_name) || empty($student_id) || empty($email) || empty($phone) || empty($address)) {
            throw new Exception('All fields are required.');
        }

        // ✅ Name validation – only letters, spaces, dots, and apostrophes
        if (!preg_match("/^[A-Za-z.' ]+$/", $full_name)) {
            throw new Exception('Full name can only contain letters, spaces, dots, and apostrophes.');
        }
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="">
                    <div class="row">
                        <div class="col-md-6">
                            <!-- ✅ Full Name Field with Frontend Validation -->
                            <div class="mb-3">
                                <label for="full_name" class="form-label">Full Name *</label>
                                <input type="text" class="form-control" id="full_name" name="full_name"
                                       value="<?php echo $_POST['full_name'] ?? ''; ?>"
                                       pattern="[A-Za-z.' ]{2,50}"
                                       title="Only letters, spaces, dots, and apostrophes allowed (2–50 chars)"
...
<!-- ✅ JavaScript for live name validation -->
<script>
